      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            İhtiyacınıza göre esnek fiyatlandırma seçenekleri. 14 gün ücretsiz deneme, kredi kartı gerekmez.
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {plans.map((plan, index) => (
            <Card key={index} className={`relative ${plan.popular ? 'border-orange-300 shadow-lg scale-105 bg-gradient-to-br from-orange-50 to-blue-50' : 'border-blue-200'}`}>
              {plan.popular && (
              ...
              <CardHeader className="text-center">
                ...
                <div className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-orange-500 bg-clip-text text-transparent">{plan.price}</div>
              ...
              <CardContent>
                ...
                <Button 
                  className={`w-full ${plan.popular ? 'bg-gradient-to-r from-orange-500 to-blue-600 hover:from-orange-600 hover:to-blue-700 text-white border-0' : 'border-blue-300 text-blue-600 hover:bg-blue-50'}`}
        ...
        <div className="text-center mt-12">
          <p className="text-muted-foreground mb-4">
            Sorularınız mı var? Satış ekibimizle konuşun.
          </p>
