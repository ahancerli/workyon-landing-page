			...
			<div className="container mx-auto px-4">
				<div className="text-center max-w-4xl mx-auto">
					...
					<p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
						Workyon ile ekibinizin moodunu takip edin, görevleri planlayın, başarıları ödüllendirin.
						Jira entegrasyonu ile mevcut iş akışınızı bozmadan çalışan wellnessını artırın.
					</p>
