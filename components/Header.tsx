...
import workyonLogo from "figma:asset/844eeb4e2f3997e3425d3fca0845accfd5419ba3.png";
    ...
    <header className="w-full border-b bg-white/80 backdrop-blur-sm fixed top-0 z-50">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          />
          <span className="font-bold text-2xl bg-gradient-to-r from-blue-600 to-orange-500 bg-clip-text text-transparent">Workyon</span>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <Button variant="ghost" className="hover:text-blue-600">Giriş Yap</Button>
