      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-orange-500 bg-clip-text text-transparent">
            Geleceğin işini <br />bugünden yaşa
          </h1>
          
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Workyon ile ekibinizin mood'unu takip edin, görevleri planlayın, başarıları ödüllendirin. 
            Jira entegrasyonu ile mevcut iş akışınızı bozmadan çalışan wellness'ını artırın.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-orange-500 bg-clip-text text-transparent">4</div>
              <div className="text-sm text-muted-foreground">Ana Modül</div>
            </div>
            <div>
              <div className="text-3xl font-bold bg-gradient-to-r from-orange-500 to-blue-600 bg-clip-text text-transparent">%95</div>
              <div className="text-sm text-muted-foreground">Kullanıcı Memnuniyeti</div>
            </div>
            <div>
              <div className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-orange-500 bg-clip-text text-transparent">24/7</div>
              <div className="text-sm text-muted-foreground">Mood Takip</div>
            </div>
            <div>
              <div className="text-3xl font-bold bg-gradient-to-r from-orange-500 to-blue-600 bg-clip-text text-transparent">∞</div>
