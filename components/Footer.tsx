				...
				<div className="grid md:grid-cols-4 gap-8">
					<div>
						...
						<p className="text-white/80 text-sm">
							Geleceğin işini bugünden yaşa. Jira entegrasyonu ile çalışan wellness ını ve iş
							verimliliğini bir arada yönetin.
						</p>
					</div>
					...
					<div>
						...
						<ul className="space-y-2 text-sm text-white/80">
							...
							<li>
								<a href="#jira-integration" className="hover:text-white transition-colors">
									Jira Entegrasyonu
								</a>
							</li>
							<li>
